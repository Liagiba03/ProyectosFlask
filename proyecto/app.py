...
def simulated_annealing(ruta, coord):
    ...
    # Imprimir el resultado con las coordenadas
    resultado = [(ciudad, coord[ciudad]) for ciudad in ruta]
    print("Resultado del algoritmo:")
    for ciudad, coordenadas in resultado:
        print(f"{ciudad}: {coordenadas}")
...
def obtener_ruta():
    ...
    # Genera una ruta inicial aleatoria que empiece en ciudad_inicio y termine en ciudad
